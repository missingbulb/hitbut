...
- Nobody ships a per-figure statement timeline; C-SPAN's person pages come closest but its terms ban bots, so it is closed off
...
- C-SPAN licensing at scale: the public terms bar automated copying, but what does a negotiated research or commercial licence actually cost and permit? The published policy answers only the unlicensed case.
